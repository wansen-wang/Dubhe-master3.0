...
public class RunCommandInnerServiceImpl implements RunCommandInnerService {
    ...
    @Override
    public String buildDisplayRunCommand(BaseTrainJobDTO baseTrainJobDTO, Long userId, boolean isTrainModelOut,
        ...
        for (TrainSystemRunParamEnum systemRunParamEnum : TrainSystemRunParamEnum.values()) {
            ...
            String param = systemRunParamHandler.buildSystemRunCommand(null, userId, null, baseTrainJobDTO, isTrainModelOut,
