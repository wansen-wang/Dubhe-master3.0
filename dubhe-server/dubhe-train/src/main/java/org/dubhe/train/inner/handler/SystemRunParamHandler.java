...
public interface SystemRunParamHandler {
     ...
     * @return
     */
    String buildSystemRunCommand(PtJupyterJobBO jobBo, Long userId, DistributeTrainBO distributeTrainBO, BaseTrainJobDTO baseTrainJobDTO, boolean isTrainModelOut,
