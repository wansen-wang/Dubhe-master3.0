...
public class SystemMountRunParamHandler implements SystemRunParamHandler {
    ...
    @Override
    public String buildSystemRunCommand(PtJupyterJobBO jobBo, Long userId, DistributeTrainBO distributeTrainBO, BaseTrainJobDTO baseTrainJobDTO, boolean isTrainModelOut,
        ...
        switch (Objects.requireNonNull(TrainSystemRunParamEnum.valueOf(paramName))) {
            case data_url:
                if (StringUtils.isBlank(baseTrainJobDTO.getDataSourcePath()) || (baseTrainJobDTO.getModelResource() != null &&
                        baseTrainJobDTO.getModelResource().equals(ModelResourceEnum.ATLAS.getType()))) {
                    break;
                }
                ...
                break;
            case val_data_url:
                if (StringUtils.isBlank(baseTrainJobDTO.getValDataSourcePath()) || (baseTrainJobDTO.getModelResource() != null &&
                        baseTrainJobDTO.getModelResource().equals(ModelResourceEnum.ATLAS.getType()))) {
                    break;
                }
