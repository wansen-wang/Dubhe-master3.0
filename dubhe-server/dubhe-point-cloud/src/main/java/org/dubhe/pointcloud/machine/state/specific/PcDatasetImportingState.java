 ...
 */
@Component
public class PcDatasetImportingState extends AbstractPcDatasetState {
    ...
    public void unlabelledPcDatasetEvent(Long datasetId) {
        pcDatasetService.updatePcDataset(new LambdaUpdateWrapper<PcDataset>()
                ...
                .set(PcDataset::getStatus, PcDatasetMachineStatusEnum.UNLABELLED.getCode()));
    }
    ...
    public String currentStatus() {
        return PcDatasetMachineStatusEnum.IMPORTING.getDesc();
    }
}
