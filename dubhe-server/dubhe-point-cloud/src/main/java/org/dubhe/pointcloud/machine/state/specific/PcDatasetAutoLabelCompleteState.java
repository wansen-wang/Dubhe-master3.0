 ...
 */
@Component
public class PcDatasetAutoLabelCompleteState extends AbstractPcDatasetState {

    @Autowired
    private PcDatasetService pcDatasetsService;

    @Override
    public void publishedPcDatasetEvent(Long datasetId) {
        pcDatasetsService.updatePcDataset(new LambdaUpdateWrapper<PcDataset>()
    ...
    public String currentStatus() {
        return PcDatasetMachineStatusEnum.AUTO_LABEL_COMPLETE.getDesc();
    }
}
