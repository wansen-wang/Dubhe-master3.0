...
/**
 * @description 自动标注失败状态类
 * @date 2022-04-02
 */
@Component
public class PcDatasetAutoLabelFailedState extends AbstractPcDatasetState {
    @Autowired
    ...
    public String currentStatus() {
        return PcDatasetMachineStatusEnum.AUTO_LABEL_FAILED.getDesc();
    }
}
