...
/**
 * @description 点云模块线程池配置类
 * @date 2020-09-02
 */
@Configuration
public class PointCloudPoolConfig {
     ...
     */
    @Bean("pointCloudExecutor")
    public Executor pointCloudAsyncExecutor() {
        ...
        //配置线程池前缀
        taskExecutor.setThreadNamePrefix("async-point-cloud-");
        //为线程设置用户信息
